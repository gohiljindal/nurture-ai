/**
 * Stage engine v2 — single age-band service for content routing (task 26).
 * Buckets: newborn → grade-readiness; use `getLifeStageBucket` from age in months.
 */
...
/** Rough month boundaries — overlap at edges is OK; callers pick one bucket. */
